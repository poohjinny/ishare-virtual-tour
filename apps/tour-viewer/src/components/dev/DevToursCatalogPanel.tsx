        ...
        <DevPanelFormGroup stacked>
          <DevPanelFormSection title='Client'>
            <label className={devViewPanelFieldClassName}>
              ...
              <p className={devViewPanelSectionHintClassName}>
                Tours belong to a catalog client. Create clients on the Client
                tab first if needed.
              </p>
            </label>
            {catalogClients.length === 0 ?
          ...
          <DevPanelFormSection title='Tour details' divided>
            ...
            <label className={devViewPanelFieldClassName}>
              ...
              />
              <p className={devViewPanelSectionHintClassName}>
                Saved to <code>catalog.json</code> with the tour entry (1–2
                sentences).
              </p>
            </label>
              ...
              <div className={devViewPanelFormCheckboxStackClassName}>
                <label className={devViewPanelFormCheckboxLabelClassName}>
                  ...
                  <span className={devViewPanelFormCheckboxFieldClassName}>
                    ...
                    <p className={devViewPanelSectionHintClassName}>
                      Shows the Tour Guide FAB and Help guidance on this tour.
                      Debug can force with <code>?askGuide=1</code> /{' '}
          ...
          <DevPanelExperienceSection
            ...
            immersivePlaylistText={newTourImmersivePlaylistText}
            onImmersivePlaylistTextChange={setNewTourImmersivePlaylistText}
            immersivePlaylistManifest={newTourImmersivePlaylistManifest}
          ...
          <DevPanelFormSection title='First scene' divided>
            ...
            <label className={devViewPanelFieldClassName}>
              ...
              <DevPanelFileField
                ...
                preview={
                  newTourPanoramaFile ?
                    <DevPanoramaFilePreview file={newTourPanoramaFile} />
                  : null
                }
            ...
            {pendingTourId && pendingFirstSceneId ?
              <p className={devViewPanelSlugPreviewClassName}>
                opaque tour id <code>{pendingTourId}</code> · opaque scene id{' '}
                <code>{pendingFirstSceneId}</code> ·{' '}
                <code>
        ...
        {tourManageClientGroups.length > 0 ?
          <label className={devViewPanelFieldClassName}>
            ...
            <select
              ...
              disabled={
                editTourStatus === 'working' || deleteTourStatus === 'working'
              }
            >
              <option value='all'>
          ...
          {filteredCatalogTourManageRows.length > 0 ?
            <ul className={devViewPanelManageListClassName}>
              {filteredCatalogTourManageRows.map((entry) => {
                ...
                const logoUrl =
                  entry.logoPath ?
                    withBaseUrl(appendCacheBust(entry.logoPath, catalogTick))
                  : null;
                const busy =
                    ...
                    <div className={devViewPanelManageListItemBodyClassName}>
                      ...
                      >
                        ...
                        >
                          ...
                          {catalogVisibilityShowsManageBadge(entry.visibility) ?
                            <div
                              className={
                                devViewPanelManageListItemSceneBadgesClassName
                              }
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() => void copyTourPublicLink(entry.id)}
                            disabled={busy}
                            aria-label={
                              (
                      ...
                      >
                        ...
                        <p
                          ...
                          title={entry.summary ? entry.summary : undefined}
                        >
                      ...
                      {isDeleting ?
                        ...
                        >
                          ...
                          <p className={devViewPanelSectionHintClassName}>
                            Permanently deletes{' '}
                            <code>tours/{entry.id}.json</code>, catalog entry,
                            and{' '}
                            <code>
                          ...
                          <DevPanelFormGroup inline manageEdit>
                            <DevPanelFormSection title='Basics'>
                              ...
                              <label className={devViewPanelFieldClassName}>
                                ...
                                />
                                <p className={devViewPanelSectionHintClassName}>
                                  Stored in <code>catalog.json</code> (1–2
                                  sentences). Not scene descriptions.
                                </p>
                              </label>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        guidance on this tour. Debug can force
                                        with <code>?askGuide=1</code> /{' '}
                                        <code>?askGuide=0</code>.
                                      </p>
                                    </span>
                                  </label>
                            ...
                            <DevPanelFormSection title='Branding' divided>
                              ...
                              {editTourBrandingMode === 'custom' ?
                                <>
                                  <div className='flex flex-col gap-1'>
                                    ...
                                    >
                                      Uses the client website from the Client
                                      tab to draft logo, favicon, and primary
                                  ...
                                  >
                                    ...
                                    Clear both font fields to revert to platform
                                    defaults.
                                  </p>
                              ...
                              <div className={devViewPanelActionsClassName}>
                                <button
                                  ...
                                  disabled={editTourStatus === 'working'}
                                >
                                  Cancel
                                </button>
                                <button
