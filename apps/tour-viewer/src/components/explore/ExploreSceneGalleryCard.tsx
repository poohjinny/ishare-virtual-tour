...
import {
  ...
  tourNavLocationGalleryHeroIdleDescriptionClassName,
...
export function ExploreSceneGalleryCard({
  ...
  } = useScenePreview(tourId, scene, mediaAllowed);
  const {
    imgRef,
        ...
        >
          ...
          <span className={tourNavLocationGalleryHeroBottomOverlayClassName}>
            <span className={tourNavLocationGalleryHeroOverlayInnerClassName}>
              ...
              {description ?
                <span
                  className={tourNavLocationGalleryHeroIdleDescriptionClassName}
                >
