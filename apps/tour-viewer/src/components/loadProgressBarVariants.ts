...
export const loadProgressVariants = cva(
  'pointer-events-none absolute inset-x-0 top-0 z-[110] h-[0.3125rem] overflow-hidden bg-[rgba(15,23,42,0.08)] opacity-100 transition-opacity duration-[220ms] ease-out',
  {
