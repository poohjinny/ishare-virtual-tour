...
async function applyCreateTourBranding({
  ...
  const normalizedFontSourceUrl = assertGoogleFontSourceUrl(fontSourceUrl);
  if (normalizedFontFamily) {
    branding.fontFamily = normalizedFontFamily;
  }
  if (normalizedFontSourceUrl) {
    branding.fontSourceUrl = normalizedFontSourceUrl;
  }
